...
@class SharedPlayer, SharedBlueDefender, SharedBlueForward, SharedBlueTeamCompanion, SharedKotlinUnit, SharedDialogState, SharedGameState, SharedGameStateFinished, SharedGameStateNonStarted, SharedGameStateStarted, SharedOrderedPlayerScores, SharedDatabase, SharedRedDefender, SharedRedForward, SharedMainScreenState, SharedMainScreenStoreCompanion, SharedPlayerScore, SharedRuntimeQuery<__covariant RowType>, SharedRedTeamCompanion, SharedAppDatabaseCompanion, SharedDatabaseDriverFactory, SharedHighScoreStore, SharedHighScoreState, SharedCFlow<T>, SharedMainScreenStore, SharedKoin_coreModule, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedRuntimeTransacterTransaction, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKotlinByteArray, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKoin_coreKoin, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreParametersHolderCompanion, SharedKotlinByteIterator, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion;

@protocol SharedTeam, SharedBlueTeam, SharedPlayerRole, SharedDefender, SharedForward, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedCloseable, SharedKotlinx_coroutines_coreStateFlow, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedRedTeam, SharedPlayerScoreQueries, SharedAppDatabase, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedKotlinx_coroutines_coreSharedFlow, SharedRuntimeSqlCursor, SharedRuntimeQueryListener, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeCloseable, SharedKoin_coreQualifier, SharedKotlinIterator, SharedKotlinKClass, SharedKotlinLazy, SharedKoin_coreScopeCallback, SharedKoin_coreKoinScopeComponent, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKoin_coreKoinComponent;
...
__attribute__((swift_name("BlueTeam")))
@protocol SharedBlueTeam <SharedTeam>
@required
@end;

__attribute__((swift_name("PlayerRole")))
@protocol SharedPlayerRole
@required
@end;

__attribute__((swift_name("Defender")))
@protocol SharedDefender <SharedPlayerRole>
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BlueDefender")))
@interface SharedBlueDefender : SharedPlayer <SharedBlueTeam, SharedDefender>
- (instancetype)initWithName:(NSString *)name __attribute__((swift_name("init(name:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedBlueDefender *)doCopyName:(NSString *)name __attribute__((swift_name("doCopy(name:)")));
...
@protocol SharedForward <SharedPlayerRole>
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BlueForward")))
@interface SharedBlueForward : SharedPlayer <SharedBlueTeam, SharedForward>
- (instancetype)initWithName:(NSString *)name __attribute__((swift_name("init(name:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedBlueForward *)doCopyName:(NSString *)name __attribute__((swift_name("doCopy(name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BlueTeamCompanion")))
@interface SharedBlueTeamCompanion : SharedBase <SharedBlueTeam>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBlueTeamCompanion *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DialogState")))
@interface SharedDialogState : SharedBase
- (instancetype)initWithPlayer:(SharedPlayer *)player __attribute__((swift_name("init(player:)"))) __attribute__((objc_designated_initializer));
- (SharedPlayer *)component1 __attribute__((swift_name("component1()")));
- (SharedDialogState *)doCopyPlayer:(SharedPlayer *)player __attribute__((swift_name("doCopy(player:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedPlayer *player __attribute__((swift_name("player")));
@end;

__attribute__((swift_name("GameState")))
@interface SharedGameState : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GameState.Finished")))
@interface SharedGameStateFinished : SharedGameState
- (instancetype)initWithWinnerTeam:(id<SharedTeam>)winnerTeam __attribute__((swift_name("init(winnerTeam:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (id<SharedTeam>)component1 __attribute__((swift_name("component1()")));
- (SharedGameStateFinished *)doCopyWinnerTeam:(id<SharedTeam>)winnerTeam __attribute__((swift_name("doCopy(winnerTeam:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<SharedTeam> winnerTeam __attribute__((swift_name("winnerTeam")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GameState.NonStarted")))
@interface SharedGameStateNonStarted : SharedGameState
- (instancetype)initWithIsStartButtonEnabled:(BOOL)isStartButtonEnabled __attribute__((swift_name("init(isStartButtonEnabled:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (SharedGameStateNonStarted *)doCopyIsStartButtonEnabled:(BOOL)isStartButtonEnabled __attribute__((swift_name("doCopy(isStartButtonEnabled:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL isStartButtonEnabled __attribute__((swift_name("isStartButtonEnabled")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GameState.Started")))
@interface SharedGameStateStarted : SharedGameState
- (instancetype)initWithBlueScore:(int32_t)blueScore redScore:(int32_t)redScore __attribute__((swift_name("init(blueScore:redScore:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (SharedGameStateStarted *)doCopyBlueScore:(int32_t)blueScore redScore:(int32_t)redScore __attribute__((swift_name("doCopy(blueScore:redScore:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t blueScore __attribute__((swift_name("blueScore")));
@property (readonly) int32_t redScore __attribute__((swift_name("redScore")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HighScoreState")))
@interface SharedHighScoreState : SharedBase
- (instancetype)initWithPlayerScores:(NSArray<SharedOrderedPlayerScores *> *)playerScores __attribute__((swift_name("init(playerScores:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<SharedOrderedPlayerScores *> *playerScores __attribute__((swift_name("playerScores")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HighScoreStore")))
@interface SharedHighScoreStore : SharedBase
- (instancetype)initWithDatabase:(SharedDatabase *)database __attribute__((swift_name("init(database:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> state __attribute__((swift_name("state")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenState")))
@interface SharedMainScreenState : SharedBase
- (instancetype)initWithBlueDefender:(SharedBlueDefender *)blueDefender blueForward:(SharedBlueForward *)blueForward redDefender:(SharedRedDefender *)redDefender redForward:(SharedRedForward *)redForward gameState:(SharedGameState *)gameState dialogState:(SharedDialogState * _Nullable)dialogState __attribute__((swift_name("init(blueDefender:blueForward:redDefender:redForward:gameState:dialogState:)"))) __attribute__((objc_designated_initializer));
- (SharedBlueDefender *)component1 __attribute__((swift_name("component1()")));
- (SharedBlueForward *)component2 __attribute__((swift_name("component2()")));
- (SharedRedDefender *)component3 __attribute__((swift_name("component3()")));
- (SharedRedForward *)component4 __attribute__((swift_name("component4()")));
- (SharedGameState *)component5 __attribute__((swift_name("component5()")));
- (SharedDialogState * _Nullable)component6 __attribute__((swift_name("component6()")));
- (SharedMainScreenState *)doCopyBlueDefender:(SharedBlueDefender *)blueDefender blueForward:(SharedBlueForward *)blueForward redDefender:(SharedRedDefender *)redDefender redForward:(SharedRedForward *)redForward gameState:(SharedGameState *)gameState dialogState:(SharedDialogState * _Nullable)dialogState __attribute__((swift_name("doCopy(blueDefender:blueForward:redDefender:redForward:gameState:dialogState:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedBlueDefender *blueDefender __attribute__((swift_name("blueDefender")));
@property (readonly) SharedBlueForward *blueForward __attribute__((swift_name("blueForward")));
@property (readonly) SharedDialogState * _Nullable dialogState __attribute__((swift_name("dialogState")));
@property (readonly) SharedGameState *gameState __attribute__((swift_name("gameState")));
@property (readonly) NSArray<SharedPlayer *> *players __attribute__((swift_name("players")));
@property (readonly) SharedRedDefender *redDefender __attribute__((swift_name("redDefender")));
@property (readonly) SharedRedForward *redForward __attribute__((swift_name("redForward")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenStore")))
@interface SharedMainScreenStore : SharedBase
- (instancetype)initWithDatabase:(SharedDatabase *)database __attribute__((swift_name("init(database:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedMainScreenStoreCompanion *companion __attribute__((swift_name("companion")));
- (void)onAddPlayerClickedPlayer:(SharedPlayer *)player __attribute__((swift_name("onAddPlayerClicked(player:)")));
- (void)onDecrementBlue __attribute__((swift_name("onDecrementBlue()")));
- (void)onDecrementRed __attribute__((swift_name("onDecrementRed()")));
- (void)onDialogDismiss __attribute__((swift_name("onDialogDismiss()")));
- (void)onIncrementBlue __attribute__((swift_name("onIncrementBlue()")));
- (void)onIncrementRed __attribute__((swift_name("onIncrementRed()")));
- (void)onPlayerNameChangedPlayer:(SharedPlayer *)player name:(NSString *)name __attribute__((swift_name("onPlayerNameChanged(player:name:)")));
- (void)onRestartGameClicked __attribute__((swift_name("onRestartGameClicked()")));
- (void)onRevengeClicked __attribute__((swift_name("onRevengeClicked()")));
- (void)onStartGameClicked __attribute__((swift_name("onStartGameClicked()")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> state __attribute__((swift_name("state")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreenStore.Companion")))
@interface SharedMainScreenStoreCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMainScreenStoreCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) int32_t WIN_SCORE __attribute__((swift_name("WIN_SCORE")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OrderedPlayerScores")))
@interface SharedOrderedPlayerScores : SharedBase
- (instancetype)initWithPosition:(int32_t)position name:(NSString *)name wins:(int32_t)wins goalsDiff:(int32_t)goalsDiff __attribute__((swift_name("init(position:name:wins:goalsDiff:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t goalsDiff __attribute__((swift_name("goalsDiff")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
@interface SharedPlayerScore : SharedBase
- (instancetype)initWithName:(NSString *)name wins:(int32_t)wins goalsDiff:(int32_t)goalsDiff __attribute__((swift_name("init(name:wins:goalsDiff:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (SharedPlayerScore *)doCopyName:(NSString *)name wins:(int32_t)wins goalsDiff:(int32_t)goalsDiff __attribute__((swift_name("doCopy(name:wins:goalsDiff:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t goalsDiff __attribute__((swift_name("goalsDiff")));
...
__attribute__((swift_name("PlayerScoreQueries")))
@protocol SharedPlayerScoreQueries <SharedRuntimeTransacter>
@required
- (void)insertPlayerScore:(SharedPlayerScore *)PlayerScore __attribute__((swift_name("insert(PlayerScore:)")));
- (SharedRuntimeQuery<SharedPlayerScore *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(NSString *, SharedInt *, SharedInt *))mapper __attribute__((swift_name("selectAll(mapper:)")));
- (SharedRuntimeQuery<SharedPlayerScore *> *)selectAllByRating __attribute__((swift_name("selectAllByRating()")));
- (SharedRuntimeQuery<id> *)selectAllByRatingMapper:(id (^)(NSString *, SharedInt *, SharedInt *))mapper __attribute__((swift_name("selectAllByRating(mapper:)")));
@end;

__attribute__((swift_name("RedTeam")))
@protocol SharedRedTeam <SharedTeam>
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RedDefender")))
@interface SharedRedDefender : SharedPlayer <SharedRedTeam, SharedDefender>
- (instancetype)initWithName:(NSString *)name __attribute__((swift_name("init(name:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedRedDefender *)doCopyName:(NSString *)name __attribute__((swift_name("doCopy(name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RedForward")))
@interface SharedRedForward : SharedPlayer <SharedRedTeam, SharedForward>
- (instancetype)initWithName:(NSString *)name __attribute__((swift_name("init(name:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedRedForward *)doCopyName:(NSString *)name __attribute__((swift_name("doCopy(name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RedTeamCompanion")))
@interface SharedRedTeamCompanion : SharedBase <SharedRedTeam>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRedTeamCompanion *shared __attribute__((swift_name("shared")));
@end;

__attribute__((swift_name("AppDatabase")))
@protocol SharedAppDatabase <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedPlayerScoreQueries> playerScoreQueries __attribute__((swift_name("playerScoreQueries")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPlayerScoresWithCompletionHandler:(void (^)(NSArray<SharedPlayerScore *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPlayerScores(completionHandler:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)observePlayerScores __attribute__((swift_name("observePlayerScores()")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)savePlayerScoresList:(NSArray<SharedPlayerScore *> *)list completionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("savePlayerScores(list:completionHandler:)")));
@end;
...
@interface SharedHighScoreStore (Extensions)
- (SharedCFlow<SharedHighScoreState *> *)watchState __attribute__((swift_name("watchState()")));
@end;

@interface SharedMainScreenStore (Extensions)
- (SharedCFlow<SharedMainScreenState *> *)watchState __attribute__((swift_name("watchState()")));
@end;
